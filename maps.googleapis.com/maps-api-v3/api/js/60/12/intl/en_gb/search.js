google.maps.__gjsload__('search', function(_) {
    var Fya = function(a) {
        ...
        Eya = function(a) {
            ...
            const d = [];
            a.Zu().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new Gya(e, b, c))
            });
            return d
        },
        Hya = class extends _.kk {};
    var Iya = {
            ["1"]: {}
        },
        Gya = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.xc(_.Nl(new _.gm((this.sn.x * 256 + this.source.a[0]) / a, (this.sn.y * 256 + this.source.a[1]) / a))).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
                    ...
                    if (!Jya.has(a)) {
                        ...
                        var c = [],
                            ...
                            e = () => {
                                ...
                                b.forEach(f => {
                                    if (f = f.data) c.push(_.Vj(f, "insert", g => {
                                        d(g, "addfeatures")
                                    })), c.push(_.Vj(f, "remove", g => {
                                        d(g, "removefeatures")
                                    }))
                                })
                            };
    ...
    FD.enableFeatureMapEventsRasterOnly = FD.enableFeatureMapEventsRasterOnly;
    _.Ok(FD.prototype, {
        map: _.Kp
    });
